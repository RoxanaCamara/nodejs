...
const collectionPermitidas = (collection = '', collections = []) => {
    ...
    if (!permitido) {
        throw new Error({ msg: `La coleccion ${collection} no es valida. Debe subir un elemento a alguna de estas colecciones ${collections}` });
    }
    return true
}
...
module.exports = {
    ...
    existNameCategorie, existCategorieForId, existProductForId, existNameProduct,
